...
import { Eye, Plus, Search, Users, X, Edit, Trash2 } from "lucide-react";
...
const KaryawanPage = () => {
  ...
  // Proses Submit (Bisa POST untuk tambah, atau PUT untuk edit)
    ...
    try {
      ...
      if (isEditMode) {
        ...
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Data karyawan baru telah ditambahkan.",
          timer: 2000,
          showConfirmButton: false,
        });
      }
      ...
      handleCloseModal();
      fetchEmployees(); // Muat ulang tabel
    } catch (error) {
      Swal.fire({
        icon: "error",
  ...
  const handleDelete = (id, name) => {
    Swal.fire({
      ...
      text: `Anda yakin ingin menghapus data ${name}? Data tidak dapat dikembalikan!`,
      icon: "warning",
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
            <Users className="text-[#1A3263]" size={28} /> Data Karyawan
          </h1>
          <p className="text-gray-500 mt-1">
            Kelola informasi dan profil karyawan PT Jaya Diga Innovation.
          </p>
        </div>
        <button
          ...
          <table className="w-full text-left table-auto min-w-max">
            <thead className="bg-gray-50 text-gray-500 text-xs uppercase font-bold border-b border-gray-200">
              <tr>
                ...
                <th className="py-4 px-4">Kode Karyawan</th>
                ...
                employees.map((emp) => (
                  <tr key={emp.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="py-4 px-4">
                      <span className="bg-blue-50 text-[#1A3263] px-3 py-1 rounded-full text-xs font-bold">
                        {emp.department || "-"}
                      </span>
                    </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Contoh: Teknik Fabrikasi"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A3263] focus:border-[#1A3263] outline-none transition-all"
                    disabled={isSubmitting}
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="contoh@jayadiga.com"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A3263] focus:border-[#1A3263] outline-none transition-all"
                    disabled={isSubmitting}
                  />
                </div>
